...
It can automatically download the correct input if you put your [Advent of Code token](https://github.com/wimglenn/advent-of-code-wim/issues/1) into a file named `token` in the root of the project.
...
```sh
cat day_<day-number>/input | vine run day_<day-number>/day_<day_number>.vi --lib util/util.vi
```
